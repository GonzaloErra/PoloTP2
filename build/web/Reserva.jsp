            ...
            <div class="header home"> 
                ...
                <div class="hero row align-items-center">
                    ...
                    <div class="col-md-5">
                        ...
                        <form action="altaReserva" method="POST">
                            <h3>Check IN</h3>
                            <input  class="form-control" type="date" name="checkin">
                            <h3>Check OUT</h3>
                            <input  class="form-control" type="date" name="checkout">
                            <input  class="form-control" type="text" name="dni" placeholder="Dni Huesped">
                            <input  class="form-control" type="text" name="Habitacion" placeholder="Nombre de Habitacion">
                            <button type="submit" class="btn btn-block">Cargar Reserva </button>
                        </form>
                        </div>
                    </div>
                </div>             
